...
Header
"%% This file was automatically generated from the file \"vscode_erlfmt_parse.yrl\"."
"%%"
...
-type anno() :: vscode_erlfmt_scan:anno().
...
-type token() :: vscode_erlfmt_scan:token().
...
ret_err(Anno, S) ->
    return_error(vscode_erlfmt_scan:get_anno(location, Anno), S).

set_parens(Expr) -> vscode_erlfmt_scan:put_anno(parens, true, Expr).

delete_parens(Expr) -> vscode_erlfmt_scan:delete_anno(parens, Expr).
